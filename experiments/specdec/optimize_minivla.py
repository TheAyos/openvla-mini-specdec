...
======================================================================
TEST 1: Baseline (HuggingFace generate, DynamicCache)
======================================================================

  Warming up Baseline (10 iterations)...
    First warmup complete
    Warmup complete
  Benchmarking Baseline (50 iterations)...
    Progress: 10/50, last: 101.4ms
    Progress: 20/50, last: 102.4ms
    Progress: 30/50, last: 144.3ms
    Progress: 40/50, last: 101.0ms
    Progress: 50/50, last: 101.4ms

  RESULT: 105.29 ± 13.27 ms (9.50 Hz)

======================================================================
TEST 2: Custom autoregressive loop
======================================================================

  Verifying Custom Loop correctness...
    Baseline: [-7.45787340e-04  1.41712178e-01 -2.96507336e-01  2.60504220e-02
  2.26889901e-04 -3.02510869e-04  0.00000000e+00]
    Custom Loop: [-7.45787340e-04  1.41712178e-01 -2.96507336e-01  2.60504220e-02
  2.26889901e-04 -3.02510869e-04  0.00000000e+00]
    Max diff: 0.00e+00, Correct: True

  Warming up Custom Loop (10 iterations)...
    First warmup complete
    Warmup complete
  Benchmarking Custom Loop (50 iterations)...
    Progress: 10/50, last: 110.8ms
    Progress: 20/50, last: 110.8ms
    Progress: 30/50, last: 184.5ms
    Progress: 40/50, last: 110.6ms
    Progress: 50/50, last: 110.8ms

  RESULT: 114.24 ± 12.02 ms (8.75 Hz)

======================================================================
TEST 4: Custom loop + torch.compile(mode='default')
======================================================================
  [OK] torch.compile applied to LLM

  Warming up Compiled (default) (10 iterations)...
    First warmup complete
    Warmup complete
  Benchmarking Compiled (default) (50 iterations)...
    Progress: 10/50, last: 71.6ms
    Progress: 20/50, last: 71.2ms
    Progress: 30/50, last: 71.3ms
    Progress: 40/50, last: 71.3ms
    Progress: 50/50, last: 71.1ms

  RESULT: 73.99 ± 8.90 ms (13.52 Hz)

======================================================================
TEST 5: Custom loop + torch.compile(mode='default') + vision backbone compile
======================================================================
  [OK] torch.compile applied to LLM
  [OK] torch.compile applied to vision backbone

  Warming up Compiled (default) (10 iterations)...
    First warmup complete
    Warmup complete
  Benchmarking Compiled (default) (50 iterations)...
    Progress: 10/50, last: 66.3ms
    Progress: 20/50, last: 66.1ms
    Progress: 30/50, last: 66.3ms
    Progress: 40/50, last: 151.1ms
    Progress: 50/50, last: 65.9ms

  RESULT: 80.12 ± 29.49 ms (12.48 Hz)
  
Method                                        Time (ms)            Hz         Speedup   
-------------------------------------------------------------------------------------
1_baseline                                    105.29 ± 13.27       9.50       1.00      x
2_custom_loop                                 114.24 ± 12.02       8.75       0.92      x
4_compiled_default                            73.99 ± 8.90         13.52      1.42      x
...
======================================================================
  ...
  Warming up Compiled (default) (10 iterations)...
    ...
    Warmup complete
  Benchmarking Compiled (default) (50 iterations)...
    Progress: 10/50, last: 66.8ms
    Progress: 20/50, last: 67.5ms
    Progress: 30/50, last: 66.4ms
    Progress: 40/50, last: 67.2ms
    Progress: 50/50, last: 70.5ms

  RESULT: 68.02 ± 4.04 ms (14.70 Hz)
...
Method                                        Time (ms)            Hz         Speedup   
-------------------------------------------------------------------------------------
1_baseline                                    104.18 ± 10.81       9.60       1.00      x
4_compiled_default                            68.02 ± 4.04         14.70      1.53      x

BEST: 4_compiled_default at 14.70 Hz (1.53x)
...
def main():
    ...
    # ========================================================================
    # Test 5: torch.compile with default mode + vision backbone compile
    # ========================================================================
    print("\n" + "=" * 70)
    print("TEST 5: Custom loop + torch.compile(mode='default') + vision backbone compile")
    print("=" * 70)
    ...
    if compiled_ok:
        try:
            model.vision_backbone.dino_featurizer = torch.compile(
                model.vision_backbone.dino_featurizer, mode="default", fullgraph=False, dynamic=True
            )
            print("  [OK] torch.compile applied to vision backbone")
            compiled_ok = True
        except Exception as e:
            print(f"  [FAIL] torch.compile failed: {e}")
            compiled_ok = False
